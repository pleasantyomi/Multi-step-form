    ...
    return ( 
        <div className="relative h-screen bg-light-gray font-primary">
            <div className="lg:absolute lg:top-[50%] lg:-translate-y-1/2 lg:left-[50%] lg:-translate-x-1/2 lg:bg-white lg:flex lg:w-8/12 h-[80vh] lg:rounded-xl  lg:shadow-sm lg:p-3">
                <div  className="flex  lg:block lg:bg-desktopbg bg-mobilebg flex-shrink-0 flex-nowrap lg:w-4/12 w-full h-full bg-contain   bg-no-repeat lg:pl-5 lg:mr-6 lg:pt-10">
                  {list.map((lists) => (
                    <div key={lists.id}>
                ...
                <div className="relative ml-6 h-full w-6/12">
